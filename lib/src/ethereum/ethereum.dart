...
class Ethereum implements _EthereumImpl {
  ...
  ///
  /// This event is emitted if it becomes unable to submit RPC requests to any chain. In general, _impl will only happen due to network connectivity issues or some unforeseen error.
  ///
  ...
  ///
  /// The MetaMask provider emits _impl event when it receives some message that the consumer should be notified of. The kind of message is identified by the type string.
  ///
